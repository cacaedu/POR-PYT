...
Copie e cole este código [neste editor Python online](https://trinket.io/) e, em seguida, clique no botão play para ver o resultado a direita. Não é necessário fazer login para, apenas, testar códigos Python nesse site (Trinket).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTMwOTA5ODMsMTU4ODA1MzM1NywtMT

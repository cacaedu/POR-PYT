...
Copie e cole este código neste editor Python e, em seguida, clique no botão play para ver o resultado a direita. Não é necessário fazer login para, apenas, testar códigos Python nesse site (Trinket).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAwMTI0MTkzOCwxNTg4MDUzMzU3LC0xMz
